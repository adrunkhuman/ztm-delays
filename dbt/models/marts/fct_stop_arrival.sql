...
select
    ...
    arrivals.pickup_type,
    arrivals.drop_off_type,
    arrivals.stop_service_class,
    arrivals.stop_execution_class,
    arrivals.classification_confidence,
    arrivals.classification_reason,
    arrivals.classification_evidence,
    arrivals.are_passenger_boundaries_settled,
