{% macro serving_delay_count_columns(delay_column='delay_seconds') %}
    ...
    countif({{ delay_column }} > -60 and {{ delay_column }} < 180) as on_time_count,
    ...
    [
        ...
        struct('early_1_to_2m' as bucket_label, -120 as min_delay_seconds, -60 as max_delay_seconds, countif({{ delay_column }} between -120 and -60) as n),
        struct('on_time_early_30_60s' as bucket_label, -59 as min_delay_seconds, -31 as max_delay_seconds, countif({{ delay_column }} between -59 and -31) as n),
        ...
        struct('on_time_late_1_to_3m' as bucket_label, 61 as min_delay_seconds, 179 as max_delay_seconds, countif({{ delay_column }} between 61 and 179) as n),
        struct('late_3_to_5m' as bucket_label, 180 as min_delay_seconds, 300 as max_delay_seconds, countif({{ delay_column }} between 180 and 300) as n),
